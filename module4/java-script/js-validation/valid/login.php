...
<body>
    ...
    <div class="container-fluide bg-light mt-0">
        ...
        <div class="row mt-5 mt-0 p-2">
            ...
            <!-- column 1 start -->
            <div class="col-md-5 ">
                <img src="images/login.gif" width="590" height="500">
            </div>
            <!-- colum 1 end -->
            ...
            <div class="col-md-7 p-2 shadow" >
                ...
                <!-- Form heading -->
                <div>
                    <h1 class="text-dark w-50 mx-auto text-center mt-5 p-2">  Login Form </h1>   
                    <hr class="border border-2 w-25 mx-auto border-dark"> 
                </div>

                <!-- Login form -->
                <div> 
                    <form method="post" name="loginfrm" onsubmit="return login_validation(this.value)" action="login-logic.php" class="p-2 mt-0">
                    ...
                    <div class="form-group mt-4">
                        ...
                        <input type="password" name="pass" id="psw" placeholder="Enter your password" class="form-control">
                    ...
                    <div class="form-group mt-4">
                        ...
                        Don't have an account? <a href="register.php"> Create Acoount? </a> 
                    </div>
                </form>
                <!-- form end -->
