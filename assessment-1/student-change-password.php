    ...
    <div class="mt-0 p-0">
        ...
        <form method="post" class="mt-2 p-5 w-75 shadow mx-auto" style="background-color:#F3DFCB;">
            ...
            <div class="form-group">
                ...
                <input type="password" name="student-old-password" placeholder="Enter Old Password" class="form-control mt-2" required>
            </div>

            <!-- new password -->
            <div class="form-group mt-4">
                <label style="color:#112046;"> New Password </label>
                <input type="text" name="student-new-password" placeholder="Enter New Password" class="form-control mt-2" required>
            </div>

            <!-- confirm password -->
            <div class="form-group mt-4">
                <label style="color:#112046;"> Confirm Password </label>
                <input type="text" name="student-confirm-password" placeholder="Confirm Password" class="form-control mt-2" required>
            </div>

            <!-- counseller-change-password-btn -->
            <div class="form-group mt-4">
                <input type="submit" name="student-change-password-btn" value="Change Password" class="btn btn-md text-light" style="margin-left:45%; background-color:#112046;">
            </div>
