    ...
    class controller extends model 
    {
        ...
        public function __construct()
        {
            ...
            if(isset($_SESSION["studentid"]))
            {
                ...
                $manage_profile = $this->manage_profile('tbl_student', 'tbl_city', 'tbl_state', 'tbl_country', 'tbl_student.city_id = tbl_city.city_id', 'tbl_student.stateid = tbl_state.state_id', 'tbl_student.country_id = tbl_country.country_id', 'student_id', $id);
            }
