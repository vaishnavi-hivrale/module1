...
<div class="container mt-5 p-5">
    <div class="row">
        ...
        <div class="col-md-12">
            <h3 class="text-primary"> Activated Cards</h3>
            ...
            ?>
                ...
                <button type="button" id="activate-card-btn" onclick="login_modal()" class="btn btn-sm btn-success ms-4"><span class="bi bi-plus fs-5"></span>&nbsp;Activate New Card</button>
            ...
            ?>
                ...
                <button type="button" data-bs-toggle="modal" data-bs-target="#activate-card" class="btn btn-sm btn-success ms-4"><span class="bi bi-plus fs-5"></span>&nbsp;Activate New Card</button>
                    ...
                    <thead>   
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <a href="<?php $mainurl ?>view-card" class="btn btn-sm btn-warning"><span class="bi bi-book"></span></a></td>
                                <td> <a href="<?php $mainurl ?>edit-card" class="btn btn-sm btn-primary"><span class="bi bi-pencil"></span></a></td>
